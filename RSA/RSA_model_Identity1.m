function [out_index,out_array]=RSA_model_Identity1(R,tmp,ii,outname)
global SL;
...
out_array={PairT MMmean MMstd MMn Mmean Mstd Mn};
out_index={'Key' ...
    [SL.design.save_str{ii} '_MMmean'] ...
    [SL.design.save_str{ii} '_MMstd'] ...
    [SL.design.save_str{ii} '_MMn'] ... 
    [SL.design.save_str{ii} '_Mmean'] ... 
    [SL.design.save_str{ii} '_Mstd'] ... 
    [SL.design.save_str{ii} '_Mn']};
...
out_array=[out_array mean(Zseries) std(Zseries) length(Zseries) ...
    mean(Cseries) std(Cseries) length(Cseries) ...
    Cseries Zseries Zzseries Iseries];
   
out_index=[out_index ...
    [SL.design.save_str{ii} '_Zmean'] ...
    [SL.design.save_str{ii} '_Zstd'] ...
    [SL.design.save_str{ii} '_Zn'] ...
    [SL.design.save_str{ii} '_Cmean'] ...
    [SL.design.save_str{ii} '_Cstd'] ...
    [SL.design.save_str{ii} '_Cn'] ...
    [SL.design.save_str{ii} '_Cseries'] ...
    [SL.design.save_str{ii} '_Zseries'] ...
    [SL.design.save_str{ii} '_zZseries'] ...
